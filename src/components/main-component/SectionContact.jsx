    ...
    return (
        <section className="contact section" id="contact">
            <div className="container">
                ...
                <div className="row">
                    <p className="contact-text" data-aos="zoom-in-up" data-aos-duration="500"  data-aos-offset="100">Vous recherchez un développeur passionné et disponible pour concrétiser vos projets ? 
                    ...
                    <div className="contact-content">
                        <a href="" className="contact-item" data-aos-duration="500"  data-aos-offset="100">
                            <i className="bx bxs-map"></i>
                            <i>Antananaraivo 101 MADAGASCAR</i>
                        </a>
                        <a href="" className="contact-item" data-aos-duration="1000"  data-aos-offset="100">
